...
function on_success(position)
{
    ...
    var    img_url = "https://maps.googleapis.com/maps/api/staticmap?center="+latlon+"&zoom=14&size=400x300&key=AIzaSyDHWmYZFLPUG3Bs_vKHSUyK-DVso85ShuI";
...
var geo_params = {enableHighAccuracy:true,timeout:1000,maximumAge:0
};
